...
if(!empty ($_POST)){
    ...
    //var_dump($userdata);
    $result = mysqli_query($link," SELECT * FROM admin WHERE adminid='$userdata[adminid]'");//
   ...
   // print_r($data);
    ...
    else
    {
        if ($newpassword == $confirmnewpassword) {
            ...
            $sql = mysqli_query($link,"UPDATE admin SET password='$newpassword' where adminid='$userdata[adminid]'");
